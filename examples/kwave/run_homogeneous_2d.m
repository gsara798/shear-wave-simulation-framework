function outcome = run_homogeneous_2d(options)
%RUN_HOMOGENEOUS_2D Run the public 2D homogeneous k-Wave example.
...
config_file = fullfile(repo_root, "configs", "kwsim", "two_d", ...
