...
[campaign,~] = ...
    kwsim.campaigns.loadCampaignJson(campaignFile);
...
[runs,validation] = ...
    kwsim.campaigns.validateCampaign(campaignFile);
...
verifyError( ...
    testCase, ...
    @() kwsim.campaigns.loadCampaignJson(temporaryFile), ...
...
[runs,expansion] = ...
    kwsim.campaigns.expandCampaign(campaignFile);
