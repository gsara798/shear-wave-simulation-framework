...
%SAVERESULTS Save field-regimes results and a readable check summary.
...
if fid < 0
    error( ...
        ...
        'Could not create field-regimes summary: %s', ...
        paths.summary_file);
end

cleanup = onCleanup(@() fclose(fid));

fprintf(fid, 'KWSIM FIELD-REGIMES 2D BENCHMARK\n');
fprintf(fid, '%s\n\n', validation.summary);
