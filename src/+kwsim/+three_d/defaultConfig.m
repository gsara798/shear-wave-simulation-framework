...
bilayer_template = struct( ...
    ...
    'negative_material', material_template, ...
    'positive_material', material_template);

cfg.geometry = struct();
cfg.geometry.background_material_id = uint16(1);
cfg.geometry.objects = repmat(object_template, 0, 1);
cfg.geometry.bilayer = bilayer_template;
