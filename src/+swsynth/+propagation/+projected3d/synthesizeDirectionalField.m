...
if isscalar(referenceCsMps)
    referenceCsByDirectionMps = ...
        repmat(referenceCsMps, directionCount, 1);

elseif numel(referenceCsMps) == directionCount
    referenceCsByDirectionMps = referenceCsMps;
    ...
    [phaseDelayZX, phaseDiagnostics] = ...
        swsynth.propagation.projected3d. ...
            computeDirectionalPhaseDelay( ...
                ...
                referenceCsByDirectionMps(directionIndex), ...
                solverOptions);
