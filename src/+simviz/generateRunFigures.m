...
if double(sample.spatial_dimension) == 3
    files.sws_crossplanes = fullfile( ...
        figDir, ...
        "sws_crossplanes.png");
    exportOne( ...
        @() simviz.plotSwsCrossplanes( ...
            sample, ...
            Visible=options.Visible), ...
        files.sws_crossplanes, ...
        options.ResolutionDPI);

    files.wavefield_amplitude_crossplanes = fullfile( ...
        figDir, ...
        "wavefield_amplitude_crossplanes.png");
    exportOne( ...
        @() simviz.plotAmplitudeCrossplanes( ...
            sample, ...
            Visible=options.Visible), ...
        files.wavefield_amplitude_crossplanes, ...
        options.ResolutionDPI);

    files.wavefield_phase_crossplanes = fullfile( ...
        figDir, ...
        "wavefield_phase_crossplanes.png");
    exportOne( ...
        @() simviz.plotPhaseCrossplanes( ...
            sample, ...
            Visible=options.Visible), ...
        files.wavefield_phase_crossplanes, ...
        options.ResolutionDPI);

    files.wavefield_real_crossplanes = fullfile( ...
        figDir, ...
        "wavefield_real_crossplanes.png");
    exportOne( ...
        @() simviz.plotFieldCrossplanes( ...
            sample, ...
            Visible=options.Visible), ...
        files.wavefield_real_crossplanes, ...
        options.ResolutionDPI);
end
