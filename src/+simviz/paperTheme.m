...
%PAPERTHEME Shared scientific-paper colors and typography.
%
% Palette: Flat UI Colors Australian / REQ-ML visual language.
...
role_names = string(fieldnames(colors));
...
theme.figure = struct( ...
    "resolution_dpi", options.ResolutionDPI);
...
if numel(parts) ~= 3
    error( ...
        "simviz:InvalidThemeColor", ...
        "Could not parse theme color '%s'.", ...
        value);
end
