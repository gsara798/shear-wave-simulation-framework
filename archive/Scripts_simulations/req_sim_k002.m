...
%   w/ reflections, free boundary, random phase, random direction
...
medium.sound_speed_compression = 1540 * rand(Nx, Ny);   % [m/s] realistic compressional speed
...
t_end = 0.01;  % [s] to allow steady-state observation
...
% Optional: save
filename = ['req_sim_k002_' num2str(source_freq) 'Hz'];
